...
const Frontend = ({opcion}) => {


const readmeContent = `# PailApp Frontend
...
- Node.js 18+
- npm o yarn
- Android Studio + emulador configurado (o dispositivo físico con USB debugging)

## Instalación
\`\`\`bash
git clone https://github.com/SaraCuellar89/PailApp_Frontend.git
cd PailApp_Frontend
npm install
\`\`\`
...
> Se usa \`run:android\` en lugar de \`expo start\` porque el proyecto modifica código nativo de Android, lo que requiere compilar la app directamente.
